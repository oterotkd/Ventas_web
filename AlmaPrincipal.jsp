...
<html lang="en">
    ...
    <body>  
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a style="margin-left: 10px; border:none" class="btn btn-outline-light disabled" href="Controlador?menu=Empleado&accion=Listar" target="myFrame">Empleado</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a style="margin-left: 10px; border:none" class="btn btn-outline-light disabled" href="Controlador?menu=Cliente&accion=Listar" target="myFrame">Cliente</a>
                        </li>
                        <li class="nav-item">
                            <a style="margin-left: 10px; border:none" class="btn btn-outline-light disabled" href="Controlador?menu=NuevaVenta&accion=default" target="myFrame">Nueva Venta</a>
                        </li>
                    </ul>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end text-center">
                            ...
                            <li><a class="dropdown-item" href="#">Rol: ${usuario.getRol()}</a></li>                            
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong> ${usuario.getNom()}</strong> Como Almacenista tienes Asceso a Productos
