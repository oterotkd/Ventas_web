...
<html lang="en">
    ...
    <body>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong> ${usuario.getNom()} </strong> Como Cajero Tienes Asceso a Botones Cliente y Nueva Venta
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a style="margin-left: 10px; border:none" class="btn btn-outline-light disabled" href="Controlador?menu=Producto&accion=Listar" target="myFrame">Producto</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end text-center">
                            ...
                            <li><a class="dropdown-item" href="#">Tel: ${usuario.getDni()}</a></li>
                            <li><a class="dropdown-item" href="#">C.C: ${usuario.getTel()}</a></li>
